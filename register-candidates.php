...
<body class="hold-transition skin-green sidebar-mini" style="background-color:white; font-family:algerian;">
<div class="wrapper">
    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20" style="font-family:algerian;">CREATE YOUR PROFILE</h1>
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="2000-01-01" max="2008-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
